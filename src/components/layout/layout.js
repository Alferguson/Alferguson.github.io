...
import { HOME, ALSO_HOME, ABOUT, BLOG, CONTACT } from "../../utils/pathnames";
...
const Layout = ({ children, path, location, title }) => {
  // Gatsby on first load for build has path = "/*" hence why we need to check for ALSO_HOME
  const isHome = path === HOME || path === ALSO_HOME;
  ...
  return (
    <>
      <div className={styles.layout}>
        ...
        <header
          className={isHome ? "headerFadeIn" : "headerFadeOut"}
